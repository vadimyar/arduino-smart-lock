...
![Проект умного замка](scr_2.pdf)

**Автономная система управления дверным замком с психоакустической индикацией и интеллектуальным контролем доступа**

Проект разработан с упором на надежность, использование свободного ПО (Linux, Arduino IDE) и комфорт пользователей. Замок прошел более 5 дней непрерывной работы без сбоев.
...
Если дверь остается открытой слишком долго:
...
3. **Визуальная LED-индикация** продолжает работать до момента закрытия двери
...
| LED индикации | D8, D11, D13 | D11 - PWM (дыхание подсветки) |
